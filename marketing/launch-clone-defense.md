...
- [x] Verify the in-game share card renders a starwars.guide URL — it's the whole organic loop. *Verified 2026-09-08 in both games: Red Five `src/meta/sharecard.js` (`SITE_URL`/`SHARE_URL`) and Clone Defense `src/meta/sharecard.js` both render starwars.guide URLs.*
