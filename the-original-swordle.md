...
description: >-
  SWordle, the Star Wars Wordle, has lived at wordle.starwars.guide since 2022. Here's how to tell the original from the copies.
...
But we'd rather you played the real one.

## How to know you're on the original
...
The word list is the game. Ours is maintained: when we ran low in 2022 we went back to Wookieepedia and added a hundred-plus new words, and in 2025 we expanded it again rather than letting the game die. A scraped copy is frozen at whatever day it was scraped, and nobody is minding it.

Play the one that's still being cared for.
